...
<div class="site-register">
    ...
    <?php elseif(!empty($error)):?>
        <h3 style="text-shadow: 0 1px 3px rgba(0,0,0,0.5);color: red;text-align: center;"><?=$error?></h3>
    <?php endif;?>
    <form class="col-md-12" action="/site/register" method="get" role="form">
        ...
        <div class="input-field col-md-4">
            <i class="material-icons prefix">password</i>
            <input id="icon_password_verify" name="verify" type="password" class="validate">
